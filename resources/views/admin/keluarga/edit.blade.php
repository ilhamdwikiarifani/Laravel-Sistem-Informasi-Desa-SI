...
@section('isi')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Update Data Keluarga </h2>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('keluargas.update',$keluarga->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('nikk') is-invalid @enderror"
                                    id="nikk" placeholder="Masukan NIK" name="nikk" value="{{ old('nikk',$keluarga->nikk) }}">
                                @error('nikk')
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <textarea name="alamat" id="alamat" placeholder="Input Alamat Lengkap"
                                    class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat',$keluarga->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('jumlah_keluarga') is-invalid @enderror"
                                    ...
                                    value="{{ old('jumlah_keluarga',$keluarga->jumlah_keluarga) }}" readonly>
