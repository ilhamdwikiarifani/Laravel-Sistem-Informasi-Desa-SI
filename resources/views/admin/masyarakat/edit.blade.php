...
@section('isi')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Ubah Data {{ $masyarakat->nama }}</h2>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('masyarakats.update', $masyarakat->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                                ...
                                <select name="keluarga_id" id="nikk"
                                    ...
                                    @foreach ($keluargas as $keluarga)
                                        <option value="{{ $keluarga->id }}"
                                            {{ old('keluarga_id', $masyarakat->keluarga_id) == $keluarga->id ? 'selected' : '' }}>
                    ...
                    <input type="hidden" name="foto_lama" value="{{ $masyarakat->foto }}">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <figure>
                                            <img width="200px" src="{{ asset('storage/' . $masyarakat->foto . '') }}"
                                            class="img-fluid img-thumbnail" alt="">
                                            <figcaption>Gambar Lama</figcaption>
                                        </figure>
                                    </div>
                                    <div class="col-sm-4">
                                        <figure>
                                            <img width="200px" class="img-fluid img-thumbnail foto-preview" alt="">
                                            <figcaption>Gambar Baru</figcaption>
                                        </figure>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="hidden" name="foto_lama" value="{{ $masyarakat->foto }}">
                                {{-- gambar baru --}}
                                <input type="file" id="foto" onchange="tampil()"
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik"
                                    placeholder="Masukan NIK" name="nik" value="{{ old('nik', $masyarakat->nik) }}">
                                @error('nik')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <select name="agama_id" id="agama"
                                    ...
                                    @foreach ($agamas as $agama)
                                        <option value="{{ $agama->id }}"
                                            {{ old('agama_id', $masyarakat->agama_id) == $agama->id ? 'selected' : '' }}>
                                            {{ $agama->nama }}</option>
                                    @endforeach
                                </select>
                                @error('agama')
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror"
                                    ...
                                    value="{{ old('tempat_lahir', $masyarakat->tempat_lahir) }}">
                                @error('tempat_lahir')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                    id="tl" placeholder="Tanggal Lahir" name="tanggal_lahir"
                                    value="{{ old('tanggal_lahir', $masyarakat->tanggal_lahir) }}">
                                @error('tanggal_lahir')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="Menikah"
                                        {{ old('status', $masyarakat->status) == 'Menikah' ? 'selected' : '' }}>
                                        Menikah</option>
                                    <option value="Belum Menikah"
                                        {{ old('status', $masyarakat->status) == 'Belum Menikah' ? 'selected' : '' }}>
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <select name="pendidikan_terakhir" id="pendidikan"
                                    ...
                                    <option value="Tidak Lulus SD"
                                        {{ old('pendidikan_terakhir', $masyarakat->pendidikan_terakhir) == 'Tidak Lulus SD' ? 'selected' : '' }}>
                                        Tidak Lulus SD</option>
                                    <option value="Lulus SD"
                                        {{ old('pendidikan_terakhir', $masyarakat->pendidikan_terakhir) == 'Lulus SD' ? 'selected' : '' }}>
                                        Lulus SD</option>
                                    <option value="Lulus SMP"
                                        {{ old('pendidikan_terakhir', $masyarakat->pendidikan_terakhir) == 'Lulus SMP' ? 'selected' : '' }}>
                                        Lulus SMP</option>
                                    <option value="Lulus SMA"
                                        {{ old('pendidikan_terakhir', $masyarakat->pendidikan_terakhir) == 'Lulus SMA' ? 'selected' : '' }}>
                                        Lulus SMA</option>
                                    <option value="Strata 1"
                                        {{ old('pendidikan_terakhir', $masyarakat->pendidikan_terakhir) == 'Strata 1' ? 'selected' : '' }}>
                                        Strata 1</option>
                                    <option value="Strata 2"
                                        {{ old('pendidikan_terakhir', $masyarakat->pendidikan_terakhir) == 'Strata 2' ? 'selected' : '' }}>
                                        Strata 2</option>
                                    <option value="Strata 3"
                                        {{ old('pendidikan_terakhir', $masyarakat->pendidikan_terakhir) == 'Strata 3' ? 'selected' : '' }}>
                                        Strata 3</option>
                                </select>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            <button type="submit" class="btn bg-core text-white">Ubah</button>
                        </div>
                    </div>
                </form>
            </div>
