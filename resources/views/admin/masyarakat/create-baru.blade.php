...
@section('isi')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Tambah Data Masyarakat Ke Keluarga {{ $nama_keluarga }}</h2>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ url('/admin/masyarakat/baru') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                                ...
                                <select name="keluarga_id" id="nikk"
                                    ...
                                    @foreach ($keluargas as $keluarga)
                                        <option value="{{ $keluarga->id }}"
                                            {{ old('keluarga_id', $id_keluarga) == $keluarga->id ? 'selected' : '' }}>
                                            {{ $keluarga->nikk }}</option>
                                    @endforeach
                                </select>
                                <input type="hidden" name="keluarga_id" value="{{ $id_keluarga }}">
                                @error('keluarga_id')
