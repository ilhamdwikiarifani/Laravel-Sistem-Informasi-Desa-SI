...
@section('isi')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Tambah List Agama </h2>
            <p class="mb-0">Harap perhatikan pengisian data !</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ url('/admin/list-agama') }}"
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('agamas.store') }}" method="POST">
                    @csrf
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                    placeholder="Input Agama" name="nama" autofocus autocomplete="off" value="{{ old('nama') }}">
                                @error('nama')
