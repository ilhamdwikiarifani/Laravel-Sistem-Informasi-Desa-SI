            ...
            <div class="card-body">
                <form method="post" action="{{ route('posts.update', $post->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                    id="slug" placeholder="Slug Otomatis" name="slug"
                        ...
                        <div class="col-sm-10">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <figure>
                                            <img width="200px" src="{{ asset('storage/' . $post->foto . '') }}"
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-sm-10">
                            <input id="body" value="{{ old('body', $post->body) }}" type="hidden"
                                name="body" class="@error('body') is-invalid @enderror">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            <button type="submit" class="btn bg-core text-white">Perbarui Postingan</button>
                        </div>
                    </div>
                </form>
            </div>
