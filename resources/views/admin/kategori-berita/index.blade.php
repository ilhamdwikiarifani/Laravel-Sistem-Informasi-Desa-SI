...
@section('isi')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Kategori Berita</h2>
            <p class="mb-0">Your web analytics dashboard template.</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ url('/admin/kategori-berita/create') }}"
                ...
                <table class="table table-centered table-nowrap mb-0 ">
                    <thead>
                        <tr>
                            ...
                            <th class="border-0 w-100">Nama Kategori</th>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <form action="{{ route('categories.destroy', $category->id) }}" method="POST">
                                            @csrf
                                            <a href="{{ url('/admin/kategori-berita/edit', $category->id) }}"
                                                style="margin:2px" class="btn btn-sm btn-warning"><i
                                            ...
                                            <button style="margin:2px" type="sumbit"
                                                class="btn btn-sm btn-danger show_confirm_kategori" data-toggle="tooltip"
